...
#                api_camps GET      /api/camps(.:format)                   api/camps#index
#                          POST     /api/camps(.:format)                   api/camps#create
#                 api_camp GET      /api/camps/:id(.:format)               api/camps#show
#                          PATCH    /api/camps/:id(.:format)               api/camps#update
#                          PUT      /api/camps/:id(.:format)               api/camps#update
#                          DELETE   /api/camps/:id(.:format)               api/camps#destroy
